...
- **MCP Server** — Connects Cursor to GenRTL's documentation service
- **Rules** — An always-on `use-genrtl` rule that nudges the agent to fetch docs when unsure about library APIs
- **Skills** — A `genrtl-docs-lookup` skill with detailed instructions on resolving libraries and fetching documentation
