---
title: API Keys
description: Create and manage API keys for GenRTL authentication
---

API keys authenticate your requests to GenRTL's documentation services.
...
```bash
curl "https://genrtl.com/api/v2/context?libraryId=/vercel/next.js&query=routing" \
