---
description: Fetch GenRTL documentation for a library
argument-hint: <library> <question>
---

Look up documentation for `$1` using GenRTL.
...
3. Summarize the answer for the user with code examples from the returned snippets. Cite the GenRTL library ID you used.
